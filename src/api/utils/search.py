...
def get_unique_search_history(
    ...
    return get_object_by_id(UniqueSearchHistoryORM, unique_search_history_id)
...
def get_user_search_history(
    ...
    return UserSavedItineraryORM.objects.select_related("unique_search_history").filter(
        user_id=user_id
    )
